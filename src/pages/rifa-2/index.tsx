...
import { getBoletosRifa1, getBoletosRifa2 } from "src/services/boletos/boletos";
...
export default function RifaDos() {
    ...
    function getBoletos(limitBot, limitTop) {
        ...
        getBoletosRifa2({ limitBot: limitBot, limitTop: limitTop }).then(function (res) {
            let auxListBoletos = [];
    ...
    function getAzarTickets(numero) {
        getBoletosRifa2({ limitBot: 1, limitTop: total_boletos }).then(function (res) {
