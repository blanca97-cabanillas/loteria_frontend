...
import { getBoletosRifa1 } from "src/services/boletos/boletos";
...
const IDENTIFICADOR = 'rifa_01';
export default function RifaUno() {
    ...
    function getBoletos(limitBot, limitTop) {
        ...
        getBoletosRifa1({ limitBot: limitBot, limitTop: limitTop }).then(function (res) {
            let auxListBoletos = [];
    ...
    function getAzarTickets(numero) {
        getBoletosRifa1({ limitBot: 1, limitTop: total_boletos }).then(function (res) {
